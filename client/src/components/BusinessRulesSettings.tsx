...
export default function BusinessRulesSettings() {
  ...
  return (
    <AccordionItem value="business-rules" className="bg-white dark:bg-card rounded-2xl border border-border/40 px-6 shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-card-hover)] transition-all duration-200">
