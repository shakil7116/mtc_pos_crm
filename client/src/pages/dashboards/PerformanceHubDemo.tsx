...
const SAMPLE: PerformanceHubData = {
  ...
  payment_reminders: [
    { customer_name: "AHMED CONSTRUCTION", customer_id: 1, phone: "97455128833", invoices: 6, outstanding: 4472.3, status_days: "152 overdue", status_severity: "high", trend: [10, 14, 12, 20, 16, 24] },
    { customer_name: "ARC INTERIOR", customer_id: 2, phone: "97453648263", invoices: 2, outstanding: 182.0, status_days: "122 overdue", status_severity: "high", trend: [6, 9, 7, 11, 8, 13] },
    { customer_name: "FARHAN TRADING", customer_id: 3, phone: "97455358869", invoices: 1, outstanding: 120.0, status_days: "70 overdue", status_severity: "medium", trend: [4, 6, 5, 3, 7, 5] },
    { customer_name: "ARAFAT HOSSAIN RAIPUR", customer_id: 4, invoices: 1, outstanding: 480.0, status_days: "Running", status_severity: "low", trend: [8, 6, 9, 7, 10, 9] },
  ],
  inventory_alerts: [
    { sku_name: "1.5MM CABLE 100M ROLL (DUCAB)", product_id: 1, current_stock: 1, min_stock: 10 },
    { sku_name: "Angle Grinder 4 INCH (MAKITA)", product_id: 17, current_stock: 2, min_stock: 8 },
    { sku_name: "Angle Valve 2 (Valves)", product_id: 6, current_stock: 0, min_stock: 12 },
    { sku_name: "Cement Sand 50KG", product_id: 20, current_stock: 3, min_stock: 20 },
  ],
  location_overview: {
    range_label: "7 days",
